...
static void lookupBench(benchmark::State &s)
{
    ...
    uint64_t succkeysnumber = pow(2, 22);
    uint64_t index = 0;
...
/*
BENCHMARK(lookupBench<Linearprobing<uint64_t, uint64_t, MultiplyShift, BulkAllocator<uint64_t, uint64_t>>>)->Name("LPMultAdd")->Ranges({{0, 2}, {0, 2}})->Unit(benchmark::kSecond);
...
*/
BENCHMARK(lookupBench<Linearprobing<uint64_t, uint64_t, MultiplyShift, BulkAllocator<uint64_t, uint64_t>>>)->Iterations(1)->Name("LPMultAdd")->Ranges({{0, 2}, {0, 2}})->Unit(benchmark::kSecond);
//BENCHMARK(lookupBench<Linearprobing<uint64_t, uint64_t, MultiplyShift, BulkAllocator<uint64_t, uint64_t>>>)->Name("LPMultAdd")->Ranges({{3, 4}, {0, 2}})->Unit(benchmark::kSecond);
/*BENCHMARK(lookupBench<Linearprobing<uint64_t, uint64_t, TabulationHashing, BulkAllocator<uint64_t, uint64_t>>>)->Name("LPTab")->Ranges({{0, 2}, {0, 2}})->Unit(benchmark::kSecond);
...
//BENCHMARK(lookupBench<Chained8<uint64_t, uint64_t, MultiplyShift, Allocator<uint64_t, uint64_t>>>)->Name("Chained8MultAdd")->Ranges({{0, 2}, {3, 4}})->Unit(benchmark::kSecond);
...
//BENCHMARK(lookupBench<Chained24<uint64_t, uint64_t, MultiplyShift, Allocator<uint64_t, uint64_t>>>)->Name("Chained24MultAdd")->Ranges({{0, 2}, {3, 4}})->Unit(benchmark::kSecond);
