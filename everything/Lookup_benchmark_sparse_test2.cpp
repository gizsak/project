...
{   
    ...
    uint64_t cap = pow(2,27);
    uint64_t *myvector = new uint64_t[cap];
    uint64_t key = 1;
    uint64_t value = 1;
...
BENCHMARK(lookupBench<Linearprobing<uint64_t ,uint64_t,MultiplyShift,BulkAllocator<uint64_t,uint64_t>>>)->Ranges({{0,2},{2,2}})->Unit(benchmark::kSecond);
BENCHMARK(lookupBench<Linearprobing<uint64_t ,uint64_t,Murmur64,BulkAllocator<uint64_t,uint64_t>>>)->Ranges({{0,2},{2,2}})->Unit(benchmark::kSecond);
...
//BENCHMARK(lookupBench<Quadraticprobing<uint64_t, uint64_t, Murmur64, BulkAllocator<uint64_t, uint64_t>>>)->Ranges({{0, 2}, {4, 5}})->Unit(benchmark::kSecond);
//BENCHMARK(lookupBench<RH<uint64_t, uint64_t, MultiplyShift, BulkAllocator<uint64_t, uint64_t>>>)->Ranges({{0, 2}, {4, 4}})->Unit(benchmark::kSecond);
//BENCHMARK(lookupBench<RH<uint64_t, uint64_t, Murmur64, BulkAllocator<uint64_t, uint64_t>>>)->Ranges({{0, 2}, {4, 4}})->Unit(benchmark::kSecond);
//BENCHMARK(lookupBench<Cuckoo<uint64_t, uint64_t, MultiplyShift, BulkAllocator<uint64_t, uint64_t>>>)->Ranges({{0, 2}, {4, 4}})->Unit(benchmark::kSecond);
...
BENCHMARK(lookupBench<Chained8<uint64_t ,uint64_t,MultiplyShift,Allocator<uint64_t,uint64_t>>>)->Ranges({{0,2},{2,2}})->Unit(benchmark::kSecond);
BENCHMARK(lookupBench<Chained8<uint64_t ,uint64_t,Murmur64,Allocator<uint64_t,uint64_t>>>)->Ranges({{0,2},{2,2}})->Unit(benchmark::kSecond);
BENCHMARK(lookupBench<Chained24<uint64_t, uint64_t, MultiplyShift, BulkAllocator<uint64_t, uint64_t>>>)->Ranges({{0, 2}, {2, 2}})->Unit(benchmark::kSecond);
BENCHMARK(lookupBench<Chained24<uint64_t, uint64_t, Murmur64, Allocator<uint64_t, uint64_t>>>)->Ranges({{0, 2}, {2, 2}})->Unit(benchmark::kSecond);
