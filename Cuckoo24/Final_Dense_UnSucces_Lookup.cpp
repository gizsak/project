...
/*
BENCHMARK(lookupBenchUnSucces<Quadraticprobing<uint64_t, uint64_t, MultiplyAddShift, BulkAllocator<uint64_t, uint64_t>>>)->Iterations(1)->Name("QPMAddF")->DenseRange(3, 5)->Unit(benchmark::kSecond);
BENCHMARK(lookupBenchUnSucces<Quadraticprobing<uint64_t, uint64_t, MultiplyShift, BulkAllocator<uint64_t, uint64_t>>>)->Iterations(1)->Name("QPMultF")->DenseRange(3, 5)->Unit(benchmark::kSecond);
BENCHMARK(lookupBenchUnSucces<Quadraticprobing<uint64_t, uint64_t, Murmur64, BulkAllocator<uint64_t, uint64_t>>>)->Iterations(1)->Name("QPMurmurF")->DenseRange(3, 5)->Unit(benchmark::kSecond);
BENCHMARK(lookupBenchUnSucces<Quadraticprobing<uint64_t, uint64_t, TabulationHashing, BulkAllocator<uint64_t, uint64_t>>>)->Iterations(1)->Name("QPTabF")->DenseRange(3, 5)->Unit(benchmark::kSecond);

BENCHMARK(lookupBenchUnSucces<RH<uint64_t, uint64_t, MultiplyAddShift, BulkAllocator<uint64_t, uint64_t>>>)->Iterations(1)->Name("RHMAdd4")->DenseRange(3, 5)->Unit(benchmark::kSecond);
BENCHMARK(lookupBenchUnSucces<RH<uint64_t, uint64_t, MultiplyShift, BulkAllocator<uint64_t, uint64_t>>>)->Iterations(1)->Name("RHMult4")->DenseRange(3, 5)->Unit(benchmark::kSecond);
BENCHMARK(lookupBenchUnSucces<RH<uint64_t, uint64_t, Murmur64, BulkAllocator<uint64_t, uint64_t>>>)->Iterations(1)->Name("RHMurmur4")->DenseRange(3, 5)->Unit(benchmark::kSecond);
BENCHMARK(lookupBenchUnSucces<RH<uint64_t, uint64_t, TabulationHashing, BulkAllocator<uint64_t, uint64_t>>>)->Iterations(1)->Name("RHTab4")->DenseRange(3, 5)->Unit(benchmark::kSecond);
